...
*/
    ...
    function ka(a, c) {
        ...
        var b = a.g.h;
        if (b)
            return la(a, "return"in b ? b["return"] : function(d) {
                return {
                    value: d,
                    done: !0
                }
    ...
    function ma(a) {
        this.next = function(c) {
            O(a.g);
            a.g.h ? c = la(a, a.g.h.next, c, a.g.o) : (a.g.o(c),
            c = U(a));
            return c
        }
        ;
        this.throw = function(c) {
            O(a.g);
            a.g.h ? c = la(a, a.g.h["throw"], c, a.g.o) : (P(a.g, c),
            c = U(a));
            return c
        }
        ;
    ...
    H("Symbol.iterator", function(a) {
        ...
        for (var c = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), b = 0; b < c.length; b++) {
            var d = G[c[b]];
            "function" === typeof d && "function" != typeof d.prototype[a] && F(d.prototype, a, {
                configurable: !0,
                writable: !0,
                value: function() {
                    return oa(aa(this))
    ...
    H("Promise", function(a) {
        ...
        c.prototype.F = function() {
            ...
            "function" === typeof e ? e = new e("unhandledrejection",{
                ...
                cancelable: !0
            }) : (e = G.document.createEvent("CustomEvent"),
        ...
        c.race = function(e) {
            return new c(function(g, h) {
                for (var l = A(e), n = l.next(); !n.done; n = l.next())
                    d(n.value).D(g, h)
            }
            )
        }
    ...
    function ua(a, c) {
        ...
        if (void 0 === a.l) {
            ...
            b.attachShader(k, f);
            b.linkProgram(k);
            if (!b.getProgramParameter(k, b.LINK_STATUS))
            ...
            b.vertexAttribPointer(a.h.u, 2, b.FLOAT, !1, 0, 0);
        ...
        b.bindBuffer(b.ARRAY_BUFFER, a.m);
        b.vertexAttribPointer(d.u, 2, b.FLOAT, !1, 0, 0);
    ...
    Aa.prototype.toArrayBuffer = function() {
        return X(this, function c() {
            ...
            return V(c, function(f) {
                return 1 == f.g ? (b.graph.url ? f = R(f, fetch(b.locateFile(b.graph.url, b.g)), 3) : (f.g = 2,
                f = void 0),
                f) : 2 != f.g && (d = f.j,
                d.body) ? f.return(d.arrayBuffer()) : f.return(new ArrayBuffer(0))
            })
        })
    }
    ;
    function Ba() {
        return X(this, function c() {
            return V(c, function(b) {
                ...
                case 1:
                    return b.m = 2,
                    R(b, WebAssembly.instantiate(va), 4);
                case 4:
                    b.g = 3;
                    b.m = 0;
                    break;
    ...
    function Ca(a) {
        return X(a, function b() {
            ...
            return V(b, function(p) {
                ...
                case 2:
                    return e = p.j,
                    R(p, Promise.all(k.map(function(u) {
                        return void 0 === u.simd || u.simd && e || !u.simd && !e ? ya(f.locateFile(u.url, f.F)) : Promise.resolve()
                    })), 3);
                case 3:
                    return g = window.createMediapipeSolutionsWasm,
                    h = window.createMediapipeSolutionsPackedAssets,
                    R(p, g(h), 4);
                case 4:
                    return d.g = p.j,
                    d.m = document.createElement("canvas"),
                    d.g.canvas = d.m,
                    d.g.createContext(d.m, !0, !0, {}),
                    d.i = new d.g.SolutionWasm,
                    l = new Aa(d.h.graph,d.locateFile,d.F),
                    R(p, d.loadGraph(l), 5);
                case 5:
                    if (d.h.listeners)
                        for (n = A(d.h.listeners),
                        y = n.next(); !y.done; y = n.next())
                            q = y.value,
                            Da(d, q);
                    d.C = !1;
                    p.g = 0
    ...
    Y.prototype.initialize = function() {
        return X(this, function c() {
            ...
            return V(c, function(d) {
                return 1 == d.g ? R(d, Ca(b), 2) : R(d, Ea(b), 0)
            })
        })
    }
    ;
                        ...
                        a: {
                            ...
                            case "video":
                                ...
                                if (u instanceof HTMLVideoElement) {
                                    ...
                                    u instanceof HTMLImageElement ? (t = u.naturalWidth,
                                    B = u.naturalHeight) : (t = u.width,
                                    B = u.height);
                                B = {
                                    glName: r.j,
                                    width: t,
    ...
    function Fa(a, c, b) {
        ...
        if (b.isRect())
            return b.getRect();
        if (b.isLandmarks())
            return b.getLandmarks();
        if (b.isLandmarksList())
            return b.getLandmarksList();
        if (b.isClassificationsList())
            return b.getClassificationsList();
        if (b.isObjectDetectionList())
            return b.getObjectDetectionList();
        if (b.isTexture2d()) {
            var d = a.j[c];
            d || (d = new ta(a.g,a.l),
            a.j[c] = d);
    ...
    function Da(a, c) {
        for (var b = c.name || "$", d = [].concat(ba(c.wants)), f = new a.g.StringList, k = A(c.wants), e = k.next(); !e.done; e = k.next())
            f.push_back(e.value);
        k = a.g.PacketListener.implement({
            onResults: function(g) {
                return X(a, function l() {
                    var n, y, q = this, p, u, r;
                    return V(l, function(t) {
                        if (1 == t.g) {
                            n = {};
                            for (y = 0; y < c.wants.length; ++y)
                                n[d[y]] = g.get(y);
                            var B;
                            if (B = c.outs) {
                                            ...
                                            if ("detection_list" === C.type) {
                                                ...
                                                if (m = v.getClassificationsList()) {
                                                    ...
                                                    for (w = 0; w < v; ++w) {
                                                        var L = m.get(w);
                                                        E = z;
                                                        for (var da = E.push, S = [], T = L.size(), M = 0; M < T; ++M) {
                                                            var Q = L.get(M);
                                                            S.push({
                                                                index: Q.index,
                                                                score: Q.score,
                                                ...
                                                throw Error("Unknown output config type: '" + C.type + "'");
                                ...
                                B = n;
                            p = B;
                            (u = q.listeners[b]) ? t = R(t, q.A, 3) : (t.g = 0,
                            t = void 0);
                            return t
                        }
                        if (r = u(p))
    ...
    Y.prototype.onResults = function(a, c) {
        this.listeners[c || "$"] = a
    }
    ;
    W("Solution", Y);
    ...
    Z.prototype.send = function(a) {
        return X(this, function b() {
            var d = this;
            return V(b, function(f) {
                return R(f, d.g.send(a), 0)
            })
        })
    }
    ;
    ...
    ;
    W("Hands", Z);
    W("HAND_CONNECTIONS", [[0, 1], [1, 2], [2, 3], [3, 4], [0, 5], [5, 6], [6, 7], [7, 8], [5, 9], [9, 10], [10, 11], [11, 12], [9, 13], [13, 14], [14, 15], [15, 16], [13, 17], [0, 17], [17, 18], [18, 19], [19, 20]]);
}
).call(this);
